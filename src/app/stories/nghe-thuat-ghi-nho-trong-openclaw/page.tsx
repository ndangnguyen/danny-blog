...
<h2 className="text-xl font-bold mt-8 border-b border-border pb-2">🧠 Bộ nhớ dài hạn (Long-term Memory)</h2>
...
<h2 className="text-xl font-bold mt-8 border-b border-border pb-2">📝 Nhật ký hàng ngày (Daily Logs)</h2>
...
<h2 className="text-xl font-bold mt-8 border-b border-border pb-2">🔖 Tự động hóa qua Bookmark</h2>
