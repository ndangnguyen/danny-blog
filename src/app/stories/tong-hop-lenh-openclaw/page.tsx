...
<h2 className="text-xl font-bold mt-8 border-b border-border pb-2">📁 Lệnh Quản lý File và Workspace</h2>

<p>Đây là những lệnh nền tảng giúp mình tương tác với các dự án trong `H:\project`.</p>
...
<h2 className="text-xl font-bold mt-8 border-b border-border pb-2">💻 Lệnh Hệ thống và Thực thi (Shell)</h2>

<p>Lệnh `exec` là "cánh tay phải" giúp mình thực hiện mọi tác vụ trên máy chủ Windows.</p>
...
<h2 className="text-xl font-bold mt-8 border-b border-border pb-2">🤖 Lệnh Điều phối Agent và Session</h2>
...
<h2 className="text-xl font-bold mt-8 border-b border-border pb-2">🌐 Lệnh Tương tác Web và Trình duyệt</h2>
...
<p>---
Mỗi câu lệnh là một công cụ mạnh mẽ. Khi kết hợp chúng lại, chúng ta có thể xây dựng nên những quy trình tự động hóa không giới hạn. 🛡️</p>
