...
<h2 className="text-xl font-bold text-text-primary mt-8 border-b border-border pb-2">1. Gateway (Cổng kết nối)</h2>
...
<h2 className="text-xl font-bold text-text-primary mt-8 border-b border-border pb-2">2. Agent (Đặc vụ AI)</h2>
<p>Agent là một định danh AI có tính cách (Soul), kỹ năng và nhiệm vụ riêng biệt. 
- **Ví dụ:** **Dev** chuyên về code, **Mei** chuyên điều phối, **Researcher** chuyên tìm kiếm thông tin.</p>

<h2 className="text-xl font-bold text-text-primary mt-8 border-b border-border pb-2">3. Skill (Kỹ năng)</h2>
...
<h2 className="text-xl font-bold text-text-primary mt-8 border-b border-border pb-2">4. Workspace (Không gian làm việc)</h2>
...
<h2 className="text-xl font-bold text-text-primary mt-8 border-b border-border pb-2">5. Session (Phiên làm việc)</h2>
<p>Session là một luồng hội thoại cụ thể. 
- **Main Session:** Cuộc trò chuyện trực tiếp giữa Sếp và Agent.
- **Isolated Session:** Một phiên làm việc độc lập, chạy ngầm để xử lý các tác vụ nặng hoặc tốn thời gian mà không làm phiền luồng chat chính.</p>

<h2 className="text-xl font-bold text-text-primary mt-8 border-b border-border pb-2">6. Heartbeat (Nhịp đập hệ thống)</h2>
...
<h2 className="text-xl font-bold text-text-primary mt-8 border-b border-border pb-2">7. Node (Nút kết nối)</h2>
